...
def main():
    ...
    print("\n[PASSO 1/3] A ler e consolidar os dados das turbinas...")
    load_and_combine_data()
    
    # Passo 2: Lógica de negócio e cálculos
    print("\n[PASSO 2/3] A calcular disponibilidade e impacto financeiro...")
    calculate_availability_and_losses()
    
    # Passo 3: Geração de relatórios visuais
    print("\n[PASSO 3/3] A gerar gráficos de resultados (Pizza e Barras)...")
